...
const UserPage = () => {
  ...
  const handleMyAccountData = async () => {
    const users = await axios.get(url).then((res) => {
      const loggedUser = res.data[index];

      setUser({
        ...user,
        accountNumber: loggedUser.customerAccountNo,
        accountHolder: loggedUser.customerName,
        accountType: loggedUser.customerAccountType,
        contact: loggedUser.customerContact,
        email: loggedUser.customerEmail,
        password: loggedUser.customerPin,
        userId: loggedUser.customerId,
      });
    });
  };
